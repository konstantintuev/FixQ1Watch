...
.method constructor <init>(Landroid/support/v4/widget/SlidingPaneLayout;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/aj;->fI:Landroid/support/v4/widget/SlidingPaneLayout;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/aj;->ev:Landroid/graphics/Rect;
...
.method private a(Landroid/support/v4/view/a/a;Landroid/support/v4/view/a/a;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/aj;->ev:Landroid/graphics/Rect;
    ...
    invoke-virtual {p2}, Landroid/support/v4/view/a/a;->getMovementGranularities()I

    move-result v0

    invoke-virtual {p1, v0}, Landroid/support/v4/view/a/a;->setMovementGranularities(I)V
...
.method public S(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/aj;->fI:Landroid/support/v4/widget/SlidingPaneLayout;

    invoke-virtual {v0, p1}, Landroid/support/v4/widget/SlidingPaneLayout;->R(Landroid/view/View;)Z
...
.method public a(Landroid/view/View;Landroid/support/v4/view/a/a;)V
    ...
    invoke-direct {p0, p2, v0}, Landroid/support/v4/widget/aj;->a(Landroid/support/v4/view/a/a;Landroid/support/v4/view/a/a;)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/aj;->fI:Landroid/support/v4/widget/SlidingPaneLayout;

    invoke-virtual {v2, v0}, Landroid/support/v4/widget/SlidingPaneLayout;->getChildAt(I)Landroid/view/View;

    move-result-object v2

    invoke-virtual {p0, v2}, Landroid/support/v4/widget/aj;->S(Landroid/view/View;)Z
...
.method public onRequestSendAccessibilityEvent(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    invoke-virtual {p0, p2}, Landroid/support/v4/widget/aj;->S(Landroid/view/View;)Z
